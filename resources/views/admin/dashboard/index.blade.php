            ...
            <script>
                ...
                async function loadDashboard() {
                    ...
                    try {
                        ...
                        if (alerts.length === 0) {
                            tbody.innerHTML =
                                '<tr><td colspan="6" class="text-center text-muted py-4">No stock alerts. All products are well-stocked.</td></tr>';
                            return;
                        }
                ...
                `);
                        ...
                        tbody.innerHTML =
                            '<tr><td colspan="6" class="text-center text-muted py-4">Failed to load dashboard data.</td></tr>';
